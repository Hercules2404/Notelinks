...
<body>
	...
	<div style="padding: 30px 120px;">
		<div style="font-size: 28px; font-weight: 600; margin-top: 50px;">POST NOT FOUND !</div>
		<div style="font-size: 20px; margin-top: 20px; border-radius: 5px; border: 1px solid #aaaaaa; padding: 9px 16px; background-color: #EEEEEE; color: #3a3a3a;">We have found some problems when processing your request
			<?php
			    ?>
			    with post's <span style="color: #0984a6;"> id <?= $id;?></span>
			    <?php
			?>
			. <br> You may not have permission to view this post or which post is deleted. We are very sorry for this inconvenient. <br> <br> Click in button below to go to homepage.</div>
